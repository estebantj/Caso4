...
({ L"el",L"al",L"la",L"lo",L"los",L"las",L"un",
	...
	L"bastante",L"bastantes",L"demasiada",
	...
	L"similar",L"muy",L"más",L"poco",L"bastante",L"menos",L"casi",L"talvez",
	L"acaso",L"quizás",L"tampoco",L"probablemente",L"seguramente",L"cuándo",L"cuán",L"ojalá",L"cuánto",L"cuánta"
	...
	L"ceñido",L"verdadero",L"feo",L"violento",L"caluroso",L"ancho",L"sabio",L"erróneo"
