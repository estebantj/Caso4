...
({ L"el",L"al",L"la",L"lo",L"los",L"las",L"un",
	...
	L"bastante",L"bastantes",L"demasiada",L"demasiadas",L"alguno",
	L"algunos",L"alguna",L"algunas",L"ninguno",	L"ninguna",L"algo",
	L"nada",L"qué",L"quién",L"quiénes",L"cuál",L"cuáles",L"cuánto",
	L"cuántos",L"cuánta",L"cuántas",L"dónde",L"cómo",L"cuyo",L"cuyos",
